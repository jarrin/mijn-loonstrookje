...
<body>
  ...
  <div class="content">
    <p>Hallo,</p>
    <p>Je bent uitgenodigd door <strong>{{ $employerName }}</strong> om deel uit te maken van <strong>{{ $companyName }}</strong> op het Mijn Loonstrookje platform.</p>
    <p>Om je account te activeren en je gegevens in te voeren, klik je op de onderstaande knop:</p>

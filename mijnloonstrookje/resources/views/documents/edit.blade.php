...
@section('content')
<section>
    <h1 class="documents-page-title">Document Bijwerken (Nieuwe Revisie)</h1>
    
    <div class="documents-alert-info">
    ...
    <div class="documents-info-card">
        <h3 class="documents-info-title">Huidige Document Informatie:</h3>
    ...
    <form action="{{ route('documents.update', $document->id) }}" method="POST" enctype="multipart/form-data" class="documents-form-container">
        @csrf
        ...
        <div class="documents-form-group">
            ...
            <input type="number" name="year" id="year" min="2000" max="2100" required value="{{ old('year', $document->year) }}" class="documents-form-input">
        </div>
        
        <div id="month_field" class="documents-form-group" style="{{ in_array(old('period_type', $document->period_type), ['Maandelijks']) ? '' : 'display: none;' }}">
        ...
        <div id="week_field" class="documents-form-group" style="{{ in_array(old('period_type', $document->period_type), ['Weekelijks', '2-wekelijks']) ? '' : 'display: none;' }}">
            <label for="week" class="documents-form-label">Week</label>
            <input type="number" name="week" id="week" min="1" max="53" value="{{ old('week', $document->week) }}" class="documents-form-input">
        </div>
        
        <div class="documents-form-group">
            <label for="document" class="documents-form-label">Nieuw Document (PDF) *</label>
            <input type="file" name="document" id="document" accept=".pdf" required class="documents-form-input">
        ...
        <div class="documents-button-group">
            ...
            <a href="{{ route('employer.employee.documents', $document->employee_id) }}" class="documents-button-secondary">
                Annuleren
            </a>
        </div>
    </form>

...
<head>
    ...
    <title>E-mail & 2-stapsverificatie - Administratiekantoor</title>
...
<body class="registrationPage">
    ...
    <div class="registrationContainer">
        <div class="registrationWrapper">
            ...
            <!-- Step Progress -->
            <x-registration.step-progress :currentStep="2" :showPaymentStep="false" />
            ...
            <div class="registrationCard">
                ...
                <x-registration.email-verification-card 
                    ...
                    :refreshUrl="route('adminoffice.verify-and-secure')" 
                />
                ...
                @if($emailVerified && $has2FAConfirmed)
                    <a href="{{ route('adminoffice.success') }}" class="formButton">Ga verder</a>
                @else

                ...
                <form action="{{ route('invitation.register', $invitation->token) }}" method="POST" class="formContainer">                @csrf
                    ...
                    <div style="display: flex; align-items: flex-start;">
                        <input 
                            ...
                            name="terms" 
                            required
                            style="margin-top: 0.25rem; height: 1rem; width: 1rem; color: rgb(59 130 246); border-color: rgb(209 213 219); border-radius: 0.25rem;"
                        >
                        <label for="terms" style="margin-left: 0.5rem; font-size: 0.875rem; color: rgb(75 85 99);">
                            Ik ga akkoord met de <a href="#" class="textLink">algemene voorwaarden</a> en <a href="#" class="textLink">privacyverklaring</a>
                        </label>
                    </div>
